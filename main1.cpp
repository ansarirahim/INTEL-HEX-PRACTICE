...
//     vector <vPageData> vMyPageData;
// };
vector<pageInformation>vMyPageInformation;
    // Line read from file
    string line;
   ...
   ///  vector <vPageInf> vMyPageInformation;
    extLACounter = 0;
    pageInformation myPageInforamtion;
    for (int j = 0; j < lineCounter; j++)
    {
        ...
        myvPageData.pageNumber=pageCounter;
...
//pageInformation myPageInforamtion;
    ...
    myPageInforamtion.extended= extendedLAddress[extLACounter];
         vMyPageInformation.push_back(myPageInforamtion);
